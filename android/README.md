...
```gradle
dependencies {
    implementation 'com.github.apiverve:randomquote-api:1.1.12'
}
```
...
```java
import com.apiverve.randomquote.RandomQuoteAPIClient;
import com.apiverve.randomquote.APIResponse;
import com.apiverve.randomquote.APIException;

// Initialize the client
RandomQuoteAPIClient client = new RandomQuoteAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/randomquote](https://docs.apiverve.com/ref/randomquote)
...
- **Documentation:** [https://docs.apiverve.com/ref/randomquote](https://docs.apiverve.com/ref/randomquote)
- **Issues:** [GitHub Issues](https://github.com/apiverve/randomquote-api/issues)
