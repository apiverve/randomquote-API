# Random Quote API - Examples

This folder contains example code for using the Random Quote API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/randomquote',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/randomquote");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/randomquote](https://docs.apiverve.com/ref/randomquote)
